...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        self.conv_output_size = 4 * 4 * 256
        self.fc = nn.Linear(self.conv_output_size, latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        self.conv_output_size = 3 * 32 * 32
        # Replace the fc layer to output 2*latent_dim
        self.fc = nn.Linear(self.conv_output_size, 2 * latent_dim)
        ##################################################################
        #                          END OF YOUR CODE                      #
        ##################################################################
